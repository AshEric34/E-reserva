    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooperative', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.cooperative')),
            ],
        ),
        migrations.AddField(
            model_name='trajet',
            name='voiture',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservation.voiture'),
        ),
        migrations.CreateModel(
            name='Chauffeur',
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('voiture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chauffeurs', to='reservation.voiture')),
            ],
        ),
    ]
